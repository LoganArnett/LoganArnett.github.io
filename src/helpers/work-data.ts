...
export const workItems: WorkItem[] = [
  {
    ...
    techStack:
      "React-Native(Registration), React(Billboard Site and Processing), Nodejs(Image Processing and Camera Tethering), AWS(Analytics and Image Storage)",
  },
  {
    ...
    techStack:
      "Angular(CMS and Admin controls), Nodejs(Server for live updates, image processing, and upload/email)",
  },
  {
    ...
    techStack:
      "React(Trivia Game Screen and Admin), React-Native(Registration and Bobblehead Gif creation), Electron(Podium screens for user answers with arcade buttons), Nodejs(Server to handle real time responses and upload to the cloud), AWS(Analytics, Gif Processing, Image and Data Storage)",
  },
  {
    ...
    techStack:
      "React/Electron(JOYTM screens and controlling the ticket printer)",
  },
  {
    ...
    techStack:
      "Angular(Interactive applications), Electron(Video players and photo booth controls), React-Native(Registration and Photo booth sign up)",
  },
  {
    ...
    techStack:
      "React(CMS and Admin control screens), React-Native(Local controls), Electron(Jukebox video player), AWS(Analytics and CMS data management)",
  },
  {
    ...
    techStack:
      "React(Admin control screens), Electron(Fish tank and Big screen content), Amazon Alexa API(Voice control)",
  },
  {
    ...
    techStack:
      "React(Admin screens), Swift(Photo booth), AWS(Image Storage and Analytics)",
  },
];
